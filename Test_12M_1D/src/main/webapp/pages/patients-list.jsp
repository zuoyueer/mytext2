...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script>
		...
		$.post("${pageContext.servletContext.contextPath}/patents/findAll",function (resoult) {
			var html="";
				for (partent of resoult){
					html+="<tr>\n" +
							"\t\t\t\t\t\t\t\t\t<td><input name=\"ids\" type=\"checkbox\"></td>\n" +
							"\t\t\t\t\t\t\t\t\t<td>"+partent.id+"</td>\n" +
							"\n" +
							...
							"\t\t\t\t\t\t\t\t\t<td>\n" +
							"\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default\" title=\"查看\"\n" +
							"\t\t\t\t\t\t\t\t\t\t\t\tonclick='location.href=\"${pageContext.servletContext.contextPath}/patents/findById?id="+partent.id+"\"'>\n" +
							"\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-file-o\"></i> 查看\n" +
							"\t\t\t\t\t\t\t\t\t\t</button>\n" +
							"\t\t\t\t\t\t\t\t\t</td>\n" +
							"\t\t\t\t\t\t\t\t</tr>"
